...
const Duration = () => {
  ...
  const [projectReportData, setProjectReportData] = useState(null); // Initialize with an empty object
    ...
    const fetchReportData = async () => {
      try {
        ...
        const initialDuration =
          res[0]?.co2_equivalent[0]?.start_date +
          " to " +
          res[0]?.co2_equivalent[0]?.end_date;
      ...
      >
        ...
        >
          <div className="duration">
            <div className="durationBox" style={{ fontSize: "2rem" }}>
              Project report is currently unavailable!!
            </div>
          </div>
        </div>
      </div>
